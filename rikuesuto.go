...
func (c Config) GetData() (string, io.Reader) {
	...
	case Form:
		return Form.GetContentType(), strings.NewReader(c.Form.Encode())
	case Multipart:
...
func NewRikuesuto(method string, config *Config) (*http.Request, error) {
...
func MustNewRikuesuto(method string, config *Config) *http.Request {
	req, err := NewRikuesuto(method, config)
	if err != nil {
		panic(err)
	}
	return req
...
func Get(config *Config) (*http.Request, error) {
	req, err := NewRikuesuto("GET", config)
	if err != nil {
		return nil, err
	}
	return req, nil
...
func Post(config *Config) (*http.Request, error) {
	req, err := NewRikuesuto("POST", config)
	if err != nil {
		return nil, err
	}
	return req, nil
...
func Put(config *Config) (*http.Request, error) {
	req, err := NewRikuesuto("PUT", config)
	if err != nil {
		return nil, err
	}
	return req, nil
...
func Patch(config *Config) (*http.Request, error) {
	req, err := NewRikuesuto("PATCH", config)
	if err != nil {
		return nil, err
	}
	return req, nil
...
func Head(config *Config) (*http.Request, error) {
	req, err := NewRikuesuto("HEAD", config)
	if err != nil {
		return nil, err
	}
	return req, nil
...
func Options(config *Config) (*http.Request, error) {
	req, err := NewRikuesuto("OPTIONS", config)
	if err != nil {
		return nil, err
	}
	return req, nil
...
func Delete(config *Config) (*http.Request, error) {
	req, err := NewRikuesuto("DELETE", config)
	if err != nil {
		return nil, err
	}
	return req, nil
...
func Trace(config *Config) (*http.Request, error) {
	req, err := NewRikuesuto("TRACE", config)
	if err != nil {
		return nil, err
	}
	return req, nil
...
func Connect(config *Config) (*http.Request, error) {
	req, err := NewRikuesuto("CONNECT", config)
	if err != nil {
		return nil, err
	}
	return req, nil
